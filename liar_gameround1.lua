...
-- ↓ 상호작용 버튼 클릭 함수 ---------------------------------------------------------------------------------
	...
	local function tapinteract_buttonEventListener( event )
		if interact_button[2].alpha == 1 then
			...
			composer.gotoScene("liar_gameround1_1") -- gameround1_사람1으로 넘어가기
		
		elseif interact_button[3].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("liar_gameround1_2") -- gameround1_사람2으로 넘어가기
		
		elseif interact_button[4].alpha == 1 then
			audio.play(sound_liar1)	
			composer.gotoScene("liar_gameround1_3") -- gameround1_사람3으로 넘어가기
		
		elseif interact_button[5].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("liar_gameround1_4") -- gameround1_사람4으로 넘어가기
		
		elseif interact_button[6].alpha == 1 then
			audio.play(sound_liar1)	
			composer.gotoScene("liar_gameround1_5") -- gameround1_사람5으로 넘어가기
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('liar_gameround1') -- 추가
	elseif phase == "did" then
