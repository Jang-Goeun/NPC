...
function scene:create( event )
	...
	local content = display.newText(dialog, "설마... 나 지금 내 컴퓨터 속에 들어온 건가...?", display.contentWidth*0.5, display.contentHeight*0.902, display.contentWidth*0.7, display.contentHeight*0.2, font_Content)
	...
	-- json에서 정보 읽기
	local Data = jsonParse("json/mainScript2.json")
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene( "mainScript2" )
	elseif phase == "did" then
