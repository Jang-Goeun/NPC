...
function scene:create( event )
	...
	choice[1].x, choice[1].y = display.contentWidth * 0.76, display.contentHeight * 0.47
	choice[1].alpha = 0

	choice[2] = display.newImageRect("image/UI/대답박스 분리.png", 900, 227)
	choice[2].x, choice[2].y = display.contentWidth * 0.76, display.contentHeight * 0.58
	choice[2].alpha = 0
