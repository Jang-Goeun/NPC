...
function scene:create( event )
	...
	local content = display.newText("이게 어떻게 된 거지?", display.contentWidth*0.5, display.contentHeight*0.902, display.contentWidth*0.7, display.contentHeight*0.2, font_Content , 45)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene( "배경화면.mainScript1" )
	elseif phase == "did" then
