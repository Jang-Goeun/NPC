...
function scene:create( event )
	...
	local picture = display.newImage("image/서브창/사진아이콘.png")
	picture.x, picture.y = display.contentWidth*0.185, display.contentHeight*0.17
	...
	local pictureIn = display.newImage("image/서브창/사진내부.png")
	pictureIn.x, pictureIn.y = display.contentCenterX, display.contentHeight*0.54
	sceneGroup:insert(pictureIn)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene( "배경화면.screen_picture" )
	elseif phase == "did" then
