...
function scene:create( event )
	...
	local content = display.newText("여긴 내가 조금 전에 나온 곳 같아. 다시 들어갈 필요는 없어.", display.contentWidth*0.5, display.contentHeight*0.902, display.contentWidth*0.7, display.contentHeight*0.2, font_Content)
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene( "배경화면.screen_garbageScript" )
	elseif phase == "did" then
