...
function scene:create( event )
	...
	local name = display.newImage("image/서브창/과제아이콘.png")
	...
	local project = display.newImage("image/서브창/과제내부.png")
	project.x, project.y = display.contentCenterX, display.contentHeight*0.56
