        ...
        for j = 1, 2 do
            ...
            local function onImageTap(event, number)
                ...
                if nextRound > 10 then
	                ...
	                composer.gotoScene("배경화면.login_death")
                    end)
                end
    ...
    if not isInitialized then
        ...
        local function counter( event )
            ...
            if(time.text == '0') then
                ...
                -- audio.stop()
                composer.gotoScene('배경화면.login_death') -- 실패
            ...
            if(correct == 5) then
                ...
                -- audio.stop()
                composer.gotoScene('배경화면.robot_loading', {effect = fade}) -- 성공
            end
...
function scene:hide( event )
	...
	if event.phase == "will" then
        ...
        composer.removeScene( "배경화면.robot_findGame" )
	elseif phase == "did" then
