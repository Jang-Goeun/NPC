...
-- ↓ 상호작용 버튼 클릭 함수 ---------------------------------------------------------------------------------
	...
	local function tapinteract_buttonEventListener( event )
		if interact_button[2].alpha == 1 then
			...
			composer.gotoScene("liar_gameround2_1") -- gameround2_1으로 넘어가기
			
		elseif interact_button[3].alpha == 1 then
			audio.play(sound_liar1)
			composer.gotoScene("liar_gameround2_2") -- gameround2_2으로 넘어가기
		
		elseif interact_button[4].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("liar_gameround2_3") -- gameround2_3으로 넘어가기
		
		elseif interact_button[5].alpha == 1 then
			audio.play(sound_liar1)
			composer.gotoScene("liar_gameround2_4") -- gameround2_4으로 넘어가기
		
		elseif interact_button[6].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("liar_gameround2_5") -- gameround2_5으로 넘어가기
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('liar_gameround2') -- 추가
	elseif phase == "did" then
