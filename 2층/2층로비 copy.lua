...
local function tapinteract_buttonEventListener( event )
	...
	if pX == nil then
		composer.setVariable("playerX", playerGroup2.x)
		composer.setVariable("playerY", playerGroup2.y)
	else
		composer.setVariable("playerX", playerGroup2.x + pX)
		composer.setVariable("playerY", playerGroup2.y + pY)
	end
