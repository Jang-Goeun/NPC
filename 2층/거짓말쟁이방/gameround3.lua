...
-- ↓ 상호작용 버튼 클릭 함수 ---------------------------------------------------------------------------------
	...
	local function tapinteract_buttonEventListener( event )
		if interact_button[2].alpha == 1 then
			...
			composer.hideOverlay("2층.거짓말쟁이방.gameround3")
			composer.gotoScene("2층.거짓말쟁이방.gameround3폴더.gameround3_사람1") -- gameround3_사람1으로 넘어가기
		
		elseif interact_button[3].alpha == 1 then
			audio.play(sound_liar2)
			composer.hideOverlay("2층.거짓말쟁이방.gameround3")
			composer.gotoScene("2층.거짓말쟁이방.gameround3폴더.gameround3_사람2") -- gameround3_사람2으로 넘어가기
		
		elseif interact_button[4].alpha == 1 then
			audio.play(sound_liar1)
			composer.hideOverlay("2층.거짓말쟁이방.gameround3")
			composer.gotoScene("2층.거짓말쟁이방.gameround3폴더.gameround3_사람3") -- gameround3_사람3으로 넘어가기
		
		elseif interact_button[5].alpha == 1 then
			audio.play(sound_liar2)
			composer.hideOverlay("2층.거짓말쟁이방.gameround3")
			composer.gotoScene("2층.거짓말쟁이방.gameround3폴더.gameround3_사람4") -- gameround3_사람4으로 넘어가기
		
		elseif interact_button[6].alpha == 1 then
			audio.play(sound_liar1)
			composer.hideOverlay("2층.거짓말쟁이방.gameround3")
			composer.gotoScene("2층.거짓말쟁이방.gameround3폴더.gameround3_사람5") -- gameround3_사람5으로 넘어가기
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('2층.거짓말쟁이방.gameround3') -- 추가
	elseif phase == "did" then
