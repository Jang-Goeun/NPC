...
-- ↓ 시작화면 배치 -----------------------=----------------------------------------------------------------------
	...
	character.x, character.y = display.contentWidth*0.24, display.contentHeight*0.5   -- 주인공
...
-- ↑ 시작화면 배치 ---------------------------------------------------------------------------------------
-------------------------json1에서 정보 읽고 적용↓(임시)-----------------------------------------------------------
	local Data = jsonParse( "2층/거짓말쟁이방/round2_json/사람1.json" )
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('2층.거짓말쟁이방.gameround2_사람1') -- 추가
	elseif phase == "did" then
