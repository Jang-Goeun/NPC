...
function scene:create( event )
	...
	local gameText = display.newText("Round 2", display.contentWidth/2, display.contentHeight*0.4)
    gameText.size = 200
	...
	local function counter( event )
		...
		if count == 1 then
			print("///////")
			composer.hideOverlay("2층.거짓말쟁이방.gameround1_black")
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene("2층.거짓말쟁이방.gameround1_black")
	elseif phase == "did" then
