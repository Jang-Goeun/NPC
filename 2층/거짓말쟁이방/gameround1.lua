...
-- ↓ 시작화면 배치 -----------------------------------------------------------------------------------------------
	...
	local truth_teller1 = 1
	composer.setVariable( "truth_teller1", truth_teller1 )
	-- ↓ 하트 ----------------------------------------------------------------------------------------------------
...
-- ↓ 상호작용 버튼 클릭 함수 ---------------------------------------------------------------------------------
	...
	local function tapinteract_buttonEventListener( event )
		if interact_button[2].alpha == 1 then
			...
			composer.gotoScene("2층.거짓말쟁이방.gameround1폴더.gameround1_사람1") -- gameround1_사람1으로 넘어가기
		
		elseif interact_button[3].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("2층.거짓말쟁이방.gameround1폴더.gameround1_사람2") -- gameround1_사람2으로 넘어가기
		
		elseif interact_button[4].alpha == 1 then
			audio.play(sound_liar1)	
			composer.gotoScene("2층.거짓말쟁이방.gameround1폴더.gameround1_사람3") -- gameround1_사람3으로 넘어가기
		
		elseif interact_button[5].alpha == 1 then
			audio.play(sound_liar2)
			composer.gotoScene("2층.거짓말쟁이방.gameround1폴더.gameround1_사람4") -- gameround1_사람4으로 넘어가기
		
		elseif interact_button[6].alpha == 1 then
			audio.play(sound_liar1)	
			composer.gotoScene("2층.거짓말쟁이방.gameround1폴더.gameround1_사람5") -- gameround1_사람5으로 넘어가기
...
function scene:hide( event )
	...
	if event.phase == "will" then
		...
		composer.removeScene('2층.거짓말쟁이방.gameround1') -- 추가
	elseif phase == "did" then
